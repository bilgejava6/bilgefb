...
function Profile() {
  ...
  const handleFileChange = event => {
    ...
    /**
     * form bileşeninin submit olma olayını dinliyor ve submit edilen dataları alıyor.
     * @param {*} event 
     */
    const handleSubmit = (event)=>{
        /**
         * submit işlemi formu belli bi action a post eder, bu işlemin ignore edilmesini sağlar
         */
        event.preventDefault();        
        /**
         * even içinde gelen form datalarının bir FormData nesnesi içine çekilmesini sağlar.
         */
        const data = new FormData(event.target);
        /**
         * formdata içindeki dataları almak için "name" property sini kullanırız.
         */
        ...
        /**
         *  ... kullanımı var olan bir nesne ya da diziyi elemanlarına ayırır.
         */
        profile.name = name;
    ...
    console.log('kullanıcı profil bigileri', profile);
    return(
        <>
            ...
            <div class="col-md-7">
              ...
              <div class="edit-profile-container">
                ...
                <div class="edit-block">
                  <form name="basic-info" id="basic-info" class="form-inline" onSubmit={handleSubmit}>
                    <div class="row">
                      <div class="form-group col-xs-6">
                        <label for="firstname">First name</label>
                        <input id="firstname" class="form-control input-group-lg" type="text" name="name" title="Enter first name" placeholder="First name" value={profile.name} />
                      </div>
                      <div class="form-group col-xs-6">
                        <label for="lastname" class="">Last name</label>
                        <input id="lastname" class="form-control input-group-lg" type="text" name="surname" title="Enter last name" placeholder="Last name" value={profile.surname} />
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-xs-12">
                        <label for="email">My email</label>
                        <input id="email" class="form-control input-group-lg" type="text" name="email" title="Enter Email" placeholder="My Email" value={profile.email} />
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="form-group col-xs-12">
                        ...
                        <textarea id="my-info" name="about" class="form-control" placeholder="Some texts about me" rows="4" cols="400" value={profile.about}>
